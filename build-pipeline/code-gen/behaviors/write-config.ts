...
export default function(configuration: Configuration)
{
  ...
  function writeConfig(): void
  {
    const developmentConfigPath = resolve(
      __dirname, "../../../configuration/development.ts"
    )
    ...
    const developmentConfigFile = "// DO NOT EDIT. This file was generated by the \"prebuild\" "
      + "script.\n\n"
    ...
    writeFileSync(resolve(configDirPath, "development.ts"), developmentConfigFile)
