...
import { Cart, MarshalledOrder, Order, ORDERS } from "@funk/model/commerce/order/order"
...
{
  return async function givenACustomer(displayName?: string): Promise<GivenACustomer>
  {
...
export async function givenASku(partialSku: Partial<MarshalledSku>): Promise<MarshalledSku>
{
