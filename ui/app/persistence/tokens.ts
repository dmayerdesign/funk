...
export const UPDATE_BY_ID =
  new InjectionToken<UpdateById>("UPDATE_BY_ID")
export const POPULATE = new InjectionToken<Populate<unknown, any>>("POPULATE")
export const QUERY_COLLECTION_FOR_METADATA =
  new InjectionToken<QueryCollectionForMetadata>("QUERY_COLLECTION_FOR_METADATA")
