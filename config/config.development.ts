...
export const CLIENT_APP_URL = "https://funk-development.web.app"
...
export const TRUSTED_ORIGINS = `${CLIENT_APP_URL},http://localhost:8100,https://funk-development.firebaseapp.com`
