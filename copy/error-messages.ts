...
export const USER_NOT_AUTHORIZED = "You don't have permission to do that. Sorry!"
export const USER_NOT_FOUND = "We couldn't find a user with that email address."
export const GENERIC = "Oops! Something went wrong. Please refresh the page and try again."
export const SERVER_WARNING =
  "Something's not quite right. You might experience better performance if you refresh "
  + "the page."
export const SERVER_ERROR = "Oops — something went wrong. Try refreshing the page."
