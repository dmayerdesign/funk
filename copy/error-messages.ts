...
export const PRODUCT_OUT_OF_STOCK_ERROR = 'Oh no — one of your chosen products is out of stock!'
export const PRODUCTS_NOT_FOUND = 'The products could not be found.'
export const EMAIL_NOT_VERIFIED = 'Your email hasn\'t yet been verified. Follow the link in the email we sent you to verify your account.'
export const INVALID_PASSWORD = 'Wrong password. Try again.'
export const USER_EMAIL_EXISTS = 'Looks like there\'s already an account with that email. Try logging in!'
export const USERNAME_EXISTS = 'Looks like there\'s already an account with that username. Try logging in!'
...
export const SERVER_WARNING = 'Something\'s not quite right. You might experience better performance if you refresh the page.'
