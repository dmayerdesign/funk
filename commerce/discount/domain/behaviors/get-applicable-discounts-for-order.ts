...
class ApplicableDiscountsForOrderBuilder extends ApplicableDiscountsBuilder<
  OrderDiscount
> {
  public constructor(discounts: OrderDiscount[], private _orderPrice: Price) {
    super(discounts)
  }
